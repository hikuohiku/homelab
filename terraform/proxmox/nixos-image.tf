...
resource "proxmox_virtual_environment_download_file" "nixos_image" {
  ...
  # Image URL from GitHub Releases (qcow2 with internal compression)
  url       = "https://github.com/${var.github_repo}/releases/download/${var.nixos_image_version}/nixos-proxmox-cloud-${var.nixos_image_version}.qcow2"
