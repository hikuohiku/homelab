...
GROUPS = [
    ...
    {
        "name": "restic/restic backup CronJob image tag (T-0098, inventory: vaultwarden-restic-image/coder-postgres-restic-image/immich-restic-image/coder-workspace-home-restic-image/syncthing-restic-image/restic-check-restic-image)",
        "targets": [
            ...
            ("apps/restic-check/cronjob.yaml", lambda: extract_image_tag_all(
                "apps/restic-check/cronjob.yaml", "image: restic/restic:"
            )),
        ],
    },
]
